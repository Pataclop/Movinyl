...
void palette(int ColorNumber, Mat img)
{
	...
	Mat colorPalette = imread("palette.png", IMREAD_COLOR);
...
void insert_in_frame(std::string name)
{
	...
	//the size of the pictures is determined in the python file,  for a 8000x5000 image.
